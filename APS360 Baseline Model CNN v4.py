...
data_dir = '/Users/raphael/Desktop/London-or-London-data_collection_panorama/report_data'

# todo: link data_dir directly to the github repo, not just local 
...
model = Sequential([
    ...
    Dense(1, activation='sigmoid')  # Use sigmoid for binary classif.
])
